...
def write_config(output_dir: str,
    ...
    # Only dataset-specific values go here (camera, paths, flags).
    # Algorithm parameters (ORB, FrontEnd, BackEnd, RelDyn, LoopClosure, Eclipse)
    # are authoritative in SatSLAM's config/pipeline.yaml.
